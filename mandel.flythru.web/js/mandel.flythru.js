...
['viewer', 'start', 'randcolors', 'reset', 'status', 'northwest', 'north', 'northeast', 'west', 'east', 'southwest', 'south', 'southeast'].map(function (x) {
    return els[x] = document.getElementById(x);
});

// Initialize the viewer.
(0, _viewer.initialize)(els.viewer);

// Initialize the Loop by letting it know how we want to talk to the server and compute on the server.
(0, _loop.initialize)(0, processors);

// Wire up the controls.  It's all up to the user now to get the mandelbrot party started.
(0, _controls.wire)(els.status, els.start, els.randcolors, els.reset, els.northwest, els.north, els.northeast, els.west, els.east, els.southwest, els.south, els.southeast);

},{"./controls":3,"./loop":4,"./viewer":7,"babel-polyfill":8}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.modes = exports.default = undefined;
...
var modes = exports.modes = new Map([[0, {

    nextImageMethod: function nextImageMethod(generator, processor, command) {
        ...
        xhr.addEventListener('load', function () {
            ...
            // Refresh the viewer.
            (0, _viewer.url)('/output/frame.jpg?dt=' + __nocache());
        });
    ...
    nextImageMethod: function nextImageMethod(generator, viewer, command) {
...
// Cache destroyer!!
var __nocache = function __nocache() {
    return new Date().getTime();
};

},{"./viewer":7}],3:[function(require,module,exports){
'use strict';
...
exports.takeNextCommand = takeNextCommand;
...
function wire(statusEl, start, randcolors, reset, nw, n, ne, w, e, sw, s, se) {

    status = statusEl;
    buttons = { start: start, randcolors: randcolors, reset: reset, nw: nw, n: n, ne: ne, w: w, e: e, sw: sw, s: s, se: se };
    ...
    flicker_id = setInterval(function () {
        ...
        if (start.style.color == 'green') start.style.color = 'black';else start.style.color = 'green';
    }, 1000);
}
...
function startpause_onclick(e) {
    ...
    var is_now_running = (0, _loop.toggle)();
...
},{"./loop":4}],4:[function(require,module,exports){
'use strict';
...
var _comms = require('./comms');

var _processors = require('./processors');

var _controls = require('./controls.js');

var _marked = [nextImageGenerator].map(regeneratorRuntime.mark); /*
...
function initialize(communicationModeNumber, processingModeNumber) {

    communication = _comms.modes.get(communicationModeNumber);
    processors = _processors.modes.get(processingModeNumber);
}
...
function nextImageGenerator() {
    var result1;
    return regeneratorRuntime.wrap(function nextImageGenerator$(_context) {
        while (1) {
...
function nextImageRequest() {
    ...
    communication.nextImageMethod(generator, processors, (0, _controls.takeNextCommand)());
}

},{"./comms":2,"./controls.js":3,"./processors":5}],5:[function(require,module,exports){
'use strict';
...
exports.default = modes;
var modes = exports.modes = new Map([[0, 'cpu-reg'], [1, 'cpu-arb'], [2, 'gpu-reg'], [3, 'gpu-arb']]);
...
// Initialize the viewer.
function initialize(vEl) {
    var initialMsg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Ready Freddie';
...
},{"core-js/fn/regexp/escape":9,"core-js/shim":302,"regenerator-runtime/runtime":304}],9:[function(require,module,exports){
